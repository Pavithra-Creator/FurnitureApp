...
#endif
    public class SceneController_Cy : MonoBehaviour
    {
        ...
        /*   public void _PinchtoZoom_cube()
          ...
          public void _MoveObject_cube()
           {
               if (Input.touchCount == 1 && gameObject.name == "cube")
               {
           ...
           public void _Rotate_cube()
           {
               Touch touch;
               touch = Input.GetTouch(0);
               if (Input.touchCount == 1 && touch.phase == TouchPhase.Moved && gameObject.name=="cube")
               {
